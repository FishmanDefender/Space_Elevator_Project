...
u_vec = simulate_gaussian(6000,150000,42300,300,1300,9.81,950,240,100)
...
anim = animation.FuncAnimation(fig, animate, init_func=init, frames=45000, interval=240, blit=False)

# anim.save('Longituninal_Gaussian.avi', fps=30, extra_args=['-vcodec', 'libx264'])
